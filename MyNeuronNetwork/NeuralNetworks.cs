...
namespace MyNeuronNetwork
{
    public class NeuralNetworks
    {
        ...
        public NeuralNetworks(Topology topology)
        {
            ...
            //Layers.Add(new Layer().Neurons.AddRange())
            CreateInputLayer();
            CreateHiddenLayers();
            CreateOutputLayer();
        }
        ...
        public double Learn(double[] expected, double[][] inputs, int epoch)
        {
            ...
            for (int i = 0; i < epoch; i++)
            {
                ...
                {
                    error += ErrorBackPropagation(expected[j], inputs[j]);
                }
            }
        ...
        // Запуск нейросети с передачей сигналов на вход
        ...
        // Единичный запуск нейросети с обратной корректировкой весов
        private double ErrorBackPropagation(double expected, params double[] inputs)
        {
